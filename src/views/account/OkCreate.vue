...
<v-ons-page>
  <v-ons-card>
    <v-ons-list>
      ...
      <v-ons-list-item>
        <b-field>
          <b-input placeholder="Amount" v-model="account.amount" type="number" v-focus="amountfocused" @focus="amountfocused = true" @blur="amountfocused = false"></b-input>
        </b-field>
      </v-ons-list-item>
      <v-ons-list-item>
        <b-field>
      ...
      <v-ons-list-item>
        <v-ons-button modifier="large" class="button-margin fab-btn" v-show="typeTitle == 'Income'" @click="addIncome">Save Income</v-ons-button>
        <v-ons-button modifier="large" class="button-margin fab-btn" v-show="typeTitle == 'Expense'" @click="addExpense">Save Expense</v-ons-button>
      </v-ons-list-item>
    </v-ons-list>
  </v-ons-card>
</v-ons-page>
