  ...
  <!-- <v-ons-card> -->
    <v-ons-page v-if="accountData != ''">
      <v-ons-card>
        ...
        <!-- </v-ons-card-content> -->
        <!-- <v-ons-card-footer> -->
          <v-ons-button modifier="large" class="button-margin" v-show="typeTitle == 'Income'" @click="editIncome">Save In</v-ons-button>
          <v-ons-button modifier="large" class="button-margin" v-show="typeTitle == 'Expense'" @click="editExpense">Save Out</v-ons-button>
        <!-- </v-ons-card-footer> -->
      </v-ons-card>
    </v-ons-page>
  <!-- </v-ons-card> -->
...
export default {
  ...
  data() {
    return {
      ...
      // account: {
      //   date: this.editDate,
      //   // date: new Date(accountData.account.date.toDate()), // Date
