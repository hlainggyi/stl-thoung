...
<v-ons-page>
  <v-ons-list style="height: 100%">
    ...
    <v-ons-list-item>
      <div class="left">
        <v-ons-icon v-if="loginForm.email != ''" style="color:green" icon="ion-email" class="list-item__icon"></v-ons-icon>
    ...
    <v-ons-list-item>
      <div class="left">
        <v-ons-icon v-if="loginForm.password != ''" style="color:green" icon="ion-android-lock" class="list-item__icon"></v-ons-icon>
    ...
    <v-ons-list-item>
      <div class="left">
        <v-ons-icon style="color:green" icon="ion-sigin" class="list-item__icon"></v-ons-icon>
      </div>
      <label class="center">
